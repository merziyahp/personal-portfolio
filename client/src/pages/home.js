...
export default function Home() {
    ...
    return (_jsxs("div", { className: "min-h-screen", children: [_jsx(Navigation, {}), _jsx(NewHero, {}), _jsx(ProfileSection, {}), _jsx(About, { description: portfolioData.about.description, principles: portfolioData.about.principles }), _jsx(CareerHighlights, { items: portfolioData.highlights.items }), _jsx(Skills, { categories: portfolioData.skills.categories }), _jsx(CaseStudies, { studies: portfolioData.caseStudies.studies }), _jsx(Writing, { title: "My Writing", description: "Thoughts on product management, leadership, and building great products.", substackUrl: "https://substack.com/@merziyahpoonawala", featured: [
                    {
                ...
                ] }), _jsx(PersonalInterests, { items: portfolioData.interests.items }), _jsx(Contact, {}), _jsx(Footer, {})] }));
}
